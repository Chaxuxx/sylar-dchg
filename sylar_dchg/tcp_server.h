 ...
 */
#ifndef __SYLAR_DCHG_TCP_SERVER_H__
#define __SYLAR_DCHG_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(sylar_dchg::IOManager* worker = sylar_dchg::IOManager::GetThis()
              ,sylar_dchg::IOManager* io_woker = sylar_dchg::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(sylar_dchg::Address::ptr addr, bool ssl = false);
