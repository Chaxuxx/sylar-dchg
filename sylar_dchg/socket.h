 ...
 */
#ifndef __SYLAR_DCHG_SOCKET_H__
#define __SYLAR_DCHG_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(sylar_dchg::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(sylar_dchg::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(sylar_dchg::Address::ptr address);
